 ...
 * Bump CACHE on every release so clients pick up new logic.
 */
const CACHE = 'lufs-rec-v0.1.0';
const SHELL = [
  './',
  './index.html',
...
self.addEventListener('fetch', (e) => {
  ...
  // Navigations: cache-first on the app shell, fall back to network, then offline shell.
